...
public class HexGridChunk : MonoBehaviour {
    ...
    //This function builds the mesh (out of triangles) from the data in the array of HexCells
    ...
    void TriangulateEstuary(EdgeVertices e1, EdgeVertices e2, bool incomingRiver)
    {
        ...
        if (incomingRiver)
        {
            ...
            estuaries.AddTriangleUV2(
                new Vector2(0.5f, 1.1f), new Vector2(1.0f, 0.8f), new Vector2(0f, 0.8f));
            estuaries.AddQuadUV2(
        ...
        HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        {
            centerL = center + HexMetrics.GetFirstCorner(direction.Previous()) * 0.25f;
            centerR = center + HexMetrics.GetSecondCorner(direction.Next()) * 0.25f;
        }
        ...
        EdgeVertices e1)
    {
        ...
        if (cell.HasRiverThroughEdge(direction))
        {
            ...
            if (!cell.isUnderwater)
            {
                ...
                {
                    TriangulateRiverQuad(e1.v1, e1.v4, e2.v2, e2.v4,
    ...
    void TriangulateRoad (
        ...
        EdgeVertices e, bool hasRoadThroughEdge)
    {
    ...
    void TriangulateRoadAdjacentToRiver (HexDirection direction, HexCell cell,
