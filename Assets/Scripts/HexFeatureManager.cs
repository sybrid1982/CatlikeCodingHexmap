...
public class HexFeatureManager : MonoBehaviour {
        ...
        bool addTower = false)
    {
        ...
        v3.y = leftTop;
        v4.y = rightTop;
        walls.AddQuadUnperturbed(v1, v2, v3, v4);   //One side of wall
        ...
        v3.y = leftTop;
        v4.y = rightTop;
        walls.AddQuadUnperturbed(v2, v1, v4, v3);   //other side of wall

        walls.AddQuadUnperturbed(t1, t2, v3, v4);   //wall top
        ...
        Vector3 c3, HexCell cell3)
    {
        if (cell1.Walled)
        {
            if (cell2.Walled)
            {
                if (!cell3.Walled)
                {
                    AddWallSegment(c3, cell3, c1, cell1, c2, cell2);    //c3 is pivot cell
                }
            } else if (cell3.Walled)
            {
                AddWallSegment(c2, cell2, c3, cell3, c1, cell1);        //c2 is pivot cell
            } else
            {
                AddWallSegment(c1, cell1, c2, cell2, c3, cell3);        //c1 is pivot cell
            }
        } else if (cell2.Walled)
        {
            if (cell3.Walled)
            {
                AddWallSegment(c1, cell1, c2, cell2, c3, cell3);        //c1 is pivot
            } else
            {
                AddWallSegment(c2, cell2, c3, cell3, c1, cell1);        //c2 is pivot
            }
        } else if (cell3.Walled)
        {
            AddWallSegment(c3, cell3, c1, cell1, c2, cell2);            //c3 is pivot
        }    
    }
